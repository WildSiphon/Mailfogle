...
Create a new project on https://console.cloud.google.com/ and add `People API` to it. Generate `ID clients OAuth 2.0`, download them and rename the file `credentials.json` before placing it in the same folder as the project.

If you're not sure, see `CONFIGURE_API.md` which explains how to do it step by step.
